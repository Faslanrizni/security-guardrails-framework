...
class AICodeDetector:
    ...
    - Commit message analysis(Check message length (AI messages are often longer), Check for markdown formatting (AI loves markdown), Check for bullet points (AI often uses bullet points), Check for explicit AI mentions (e.g., "generated by Copilot"))
    - Code pattern matching(Check for AI signature comments (e.g., "Generated by ChatGPT"), Check for placeholder names (e.g., "foo", "temp"), Check for repetitive patterns (AI often repeats code), Check for many small functions/classes (AI generates many small functions/classes))
    - Entropy calculation (AI-generated code often has higher entropy due to less predictable patterns)
    - Comment density analysis(AI code often has a high density of comments, especially verbose explanations)
    """
    ...
    def scan_commit(self, commit_hash: str = "HEAD") -> List[Dict]:
        ...
        if not files:
            print("   No files found in commit")
            return []
    ...
    def _print_report(self):
        ...
        if not self.findings:
            print("No AI-generated code detected")
            return
        ...
        if requires_review:
            print(f"\n REQUIRES EXTRA REVIEW ({len(requires_review)})")
...
def main():
    ...
    if args.block and detector.should_block():
        print("\n AI-GENERATED CODE REQUIRES REVIEW - BLOCKING")
        sys.exit(1)
